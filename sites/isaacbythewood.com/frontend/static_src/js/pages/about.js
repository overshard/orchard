...
export const initAbout = () => {
  ...
  window.setInterval(() => {
    // Same as the home page word cycle. The work is deferred behind
    // requestAnimationFrame, which is suspended in a hidden tab, so without
    // this the queue bursts on return.
