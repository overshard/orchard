...
//
// The same compiler the PDF report already needs at runtime, used once at
// build.
...
#place(dx: 110pt, dy: 92pt, text(size: 76pt, weight: "bold", tracking: -2pt)[Logging])
#place(dx: 110pt, dy: 190pt, text(size: 30pt, fill: rgb("#9aa3b2"))[Self-hosted log aggregation])

#place(dx: 80pt, dy: 470pt, line(length: 1040pt, stroke: 1pt + rgb("#30363d")))
#place(dx: 80pt, dy: 508pt, text(size: 24pt, fill: rgb("#c9d1d9"))[logging.bythewood.me])
#place(dx: 80pt, dy: 550pt, text(size: 20pt, fill: rgb("#6f7789"))[Structured records from every site, shipped in process, read as graphs])
