...
#place(dx: 110pt, dy: 92pt, text(size: 76pt, weight: "bold", tracking: -2pt)[Analytics])
#place(dx: 110pt, dy: 190pt, text(size: 30pt, fill: rgb("#9aa3b2"))[Self-hosted website analytics])

#place(dx: 80pt, dy: 470pt, line(length: 1040pt, stroke: 1pt + rgb("#30363d")))
#place(dx: 80pt, dy: 508pt, text(size: 24pt, fill: rgb("#c9d1d9"))[analytics.bythewood.me])
#place(dx: 80pt, dy: 550pt, text(size: 20pt, fill: rgb("#6f7789"))[Page views, clicks, scrolls, sessions and custom events])
