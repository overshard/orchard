...
// Report export: the dashboard's data as a PDF, or as Markdown.
...
// document full of &amp;. Escaping still happens, through typstMD and typstStr
// below, which know what is dangerous in Typst rather than in HTML.
//
//go:embed reports
