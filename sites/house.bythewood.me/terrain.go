...
// FenceNote returns what the listing said about a fence, and an empty string when
// it said nothing. Empty means not mentioned rather than not there, which is why
// this is a bonus and never a penalty.
func FenceNote(l Listing) string {
	hay := strings.ToLower(l.Remarks + " " + l.Style)
